...
function procesarEventos()
{
	if(conexion.readyState == 4)
	{
		...
		for(var i in conversacionJson)
		{
			...
			document.getElementById(conversacionJson[i].idConversacion.toString());//.addEventListener('click', function(){guardarConversacion(conversacionJson[i].idConversacion)}, false);
		}
